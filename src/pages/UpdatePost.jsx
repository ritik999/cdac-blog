...
const UpdatePost = () => {
    ...
    const {currentUser}=useSelector(state=>state.userDate);
    ...
    <div className='max-w-3xl mx-auto p-3 min-h-screen'>
        ...
        <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
            <div className='flex justify-between flex-col md:flex-row gap-4'>
                <TextInput placeholder='Title' className='flex-1' value={formData.title} onChange={(e)=>setFormData({...formData,title:e.target.value})} />
            ...
            <ReactQuill onChange={(value)=>setFormData({...formData,content:value})} value={formData.content} theme="snow" placeholder='do something' className='h-72 mb-12' required/>
